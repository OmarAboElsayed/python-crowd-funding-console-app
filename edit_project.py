...
def edit_project(user_mail):
    ...
    for dict in list:
        if dict['Title'] == project_title and dict['User'] == user_mail:
            project = {"Title": input("Please Enter Your New Project Title: "),
                       "Details": input("Please Enter Your New Project Details: "),
                       "Total_Target": input("Please Enter Your  New Total Target: "),
